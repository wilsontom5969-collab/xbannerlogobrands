...
async function run() {
  await supabase.from('slot_bookings').update({ holder_name: 'Cornerstone' }).in('id', ['f5df98ba-b90f-4780-900f-09b2057b0ebe', '8b993c31-4419-4332-bbfb-f996f560b202']);
  await supabase.from('slots').update({ holder_name: 'Cornerstone' }).eq('id', 'big-3');
  console.log('Fixed: set holder_name to Cornerstone');
}
run();
