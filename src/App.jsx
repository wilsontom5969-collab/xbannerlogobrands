    ...
    <>
      ...
      <main className="container">
        ...
        <section id="how-it-works" className="mb-16">
          ...
          <div style={{ 
            ...
            <div style={{ padding: '2rem', background: 'var(--color-hover)', borderRadius: '12px' }}>
              <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>1. Pick a spot</h3>
              <p style={{ fontSize: '0.95rem' }}>Choose between Micro, Small (fixed price), or Big (bidding war) slots.</p>
            </div>
            <div style={{ padding: '2rem', background: 'var(--color-hover)', borderRadius: '12px' }}>
              <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>2. Pay / Bid</h3>
              <p style={{ fontSize: '0.95rem' }}>Enter your brand info, upload a logo, and checkout. Bidders only pay if they win.</p>
            </div>
            <div style={{ padding: '2rem', background: 'var(--color-hover)', borderRadius: '12px' }}>
              <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>3. Go Live</h3>
        ...
        <section className="mb-16" style={{ display: 'flex', alignItems: 'center', gap: '2rem', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 300px' }}>
            ...
            <div style={{ display: 'flex', gap: '1.2rem', alignItems: 'center' }}>
              {/* Instagram */}
              <a href="https://instagram.com/" target="_blank" rel="noreferrer" style={{ color: 'var(--color-accent)', display: 'flex', alignItems: 'center' }} aria-label="Instagram">
              ...
              {/* X (Twitter) */}
              <a href="https://x.com/writtenbywilson" target="_blank" rel="noreferrer" style={{ color: 'var(--color-accent)', display: 'flex', alignItems: 'center' }} aria-label="X (Twitter)">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* LinkedIn */}
              <a href="https://linkedin.com/" target="_blank" rel="noreferrer" style={{ color: 'var(--color-accent)', display: 'flex', alignItems: 'center' }} aria-label="LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <footer style={{
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'center', gap: '2rem' }}>
          <a href="#terms" style={{ textDecoration: 'underline' }}>Terms & Refund Policy</a>
          <a href="mailto:contact@example.com" style={{ textDecoration: 'underline' }}>contact@example.com</a>
          <a href="https://x.com/writtenbywilson" target="_blank" rel="noreferrer" style={{ textDecoration: 'underline' }}>@writtenbywilson on X</a>
        </div>
      </footer>
